...
Idify.prototype._onConnect = function(client) {
  ...
  this.sadd = Promise.promisify(this.client.sadd, {context: this.client});
...
Idify.prototype.get = function() {
  ...
  return new Promise(function(resolve, reject) {
    ...
    var key = self.getKey();
    self._recurse(key, id, resolve, reject, loops);
  });
};

/**
 * Recursive method until a unique id is found.
 *
 * @param {string} key The redis SET store key.
 * @param {string} id The id to try.
 * @param {Function} resolve Promise resolve.
 * @param {Function} reject Promise reject.
 * @param {number} loops Safenet.
 * @private
 */
Idify.prototype._recurse = function(key, id, resolve, reject, loops) {
  var self = this;
